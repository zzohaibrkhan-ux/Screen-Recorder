  ...
  const saveRecordingOffline = async (blob, type = 'screen') => {
    try {
      const recordingData = {
        ...
        size: blob.size,
        name: `${type}-recording-${new Date().toISOString().slice(0, 19).replace(/:/g, '-')}`
      }
          ...
          <TabsContent value="record" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  {/* Camera Recording */}
                  <Button
                    onClick={isRecording ? stopRecording : startCameraRecording}
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {isRecording ? 'Live preview' : recordedBlob ? 'Recorded video' : 'No recording available'}
                </CardDescription>
              </CardHeader>
              <CardContent>
